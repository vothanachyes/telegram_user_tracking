...
CREATE TABLE IF NOT EXISTS app_settings (
    ...
    max_file_size_mb INTEGER NOT NULL DEFAULT 3,
    fetch_delay_seconds REAL NOT NULL DEFAULT 5.0,
    download_photos BOOLEAN NOT NULL DEFAULT 0,
    download_videos BOOLEAN NOT NULL DEFAULT 0,
    download_documents BOOLEAN NOT NULL DEFAULT 0,
    download_audio BOOLEAN NOT NULL DEFAULT 0,
...
-- User Groups Table (tracks which groups users have joined)
